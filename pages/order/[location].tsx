...
export default function Order() {
  ...
  if(locationData.lenght == 0 || locationData == null){
      ...
      <div className='order-con'>
        <div className="hero">
          <div className="img-con">
            <Image src={locationData?.background} alt='hero img' title='Kamil Gliwiński - unsplash' layout='fill' />
          </div>
          ...
          {locationData?.res?.map((item: any) => {
            ...
            return(
              <div className="res-con">
                <Image src={item?.img} alt='hero img' title={`${item?.img_taker} - unsplash`} layout='fill' />
